 (function() {
  ...
  function component(object) {
    ...
    function showAuthModal() {
      Lampa.Storage.set('isCodeObtained', false);
      ...
      function checkAuthorization() {
          ...
          $.ajax({
              ...
              success: function(response) {
                  Lampa.Storage.set('isCodeObtained', true);
              },
      ...
      function showModal() {
        if (Lampa.Storage.get('isCodeObtained')) return;
        ...
        function getRandomCode() {
          ...
          getRandomCode()
              ...
              .fail(function(jqXHR, textStatus, errorThrown) {
                  console.error('Error obtaining code:', textStatus, errorThrown);
                  Lampa.Storage.set('isCodeObtained', true);
                  $('.modal').remove();
              ...
              Lampa.Modal.open({
                  ...
                  html: $(modalHtml),
                  buttons: [{
                      name: 'ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ ÐºÐ¾Ð´',
                      onSelect: function onSelect() {
                        checkCode()
                      }
                  },{
                    name: 'ÐŸÑ€Ð¾Ð¿ÑƒÑÑ‚Ð¸Ñ‚ÑŒ',
                    onSelect: function onSelect() {
                        Lampa.Storage.set('isCodeObtained', true);
                        $('.modal').remove();
                        Lampa.Controller.toggle('content')
          ...
          function checkCode() {
              ...
              const randomCode = document.getElementById('randomCodeDisplay').innerText;
              $.ajax({
          ...
          function handleFailedAttempts() {
              ...
              if (attempts < maxAttempts) {
                  ...
                  alert('Ð’Ñ€ÐµÐ¼Ñ Ð¾Ð¶Ð¸Ð´Ð°Ð½Ð¸Ñ Ð¸ÑÑ‚ÐµÐºÐ»Ð¾. ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹Ñ‚Ðµ ÑÐ½Ð¾Ð²Ð°.');
              }
          }
          // handleFailedAttempts();
